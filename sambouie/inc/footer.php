...
<div class="container grid grid--footer">
  <div class="logo-col">
    ...
    <p class="copyright">
      Copyright &copy; <span class="year">2027</span> by Sambouie LLC
      All rights reserved.
    </p>
  </div>
  ...
  <div class="address-col">
    ...
    <!-- <address class="contacts">
      ...
      <p>
        ...
        ><br />
        <a class="footer-link" href="mailto:sambouie@sambouie.com"
          >sambouie@sambouie.com</a
        >
      </p>
    </address> -->
  ...
  <nav class="nav-col">
    ...
    <ul class="footer-nav">
      <li><a class="footer-link" href="./register.php">Create account</a></li>
