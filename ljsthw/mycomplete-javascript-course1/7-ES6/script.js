...
adminstration, and you're in charge of two town elements:
1. Parks
2. Streets
...
class Park extends Town {
    ...
    calcTreeDensity(numTrees, parkArea) {
      console.log(`${this.name} has a tree Density of ${(numTrees / parkArea) * 100}%`);
    }

    calcAvgPark(totAges, totPark) {
      console.log(`${totAges / totPark}`);
    }

    nameParkMoreThan(trees) {
...
class Streets extends Town {
  ...
  calcTotStreet(totStreet) {
     console.log(`${totStreet}`);
     return totStreet;
  }
  calcAvgStreet(numStreet) {
    let total = this.calcTotStreet(numStreet);
    console.log(`${total / numStreet}`);
  }
  ...
  sizeClass(sizeC) {
   ...
   else if (sizeC < 100 & sizeC > 50) {
      console.log("medium street");
    }
   else if (sizeC < 50 & sizeC > 25) {
     console.log("small street");
   }

   else {
     console.log("very small street");
   }
}

}

const streets = ['National Park', 'Graceland Avenue', 'Smarty Pants', 'Boss Area'];
const park = ['Jade Braces', 'King Mistress', 'Dog House', 'LSU'];

console.log("------Parks Report -------------");
new Park('Alante', 1994).calcTreeDensity(4, 5);
new Park('Alante', 1994).calcAvgPark(100, 20);
new Park('Alante', 1994).nameParkMoreThan(1001);

console.log("------Streets Report -------------");
new Streets('Alante', 1994).calcTotStreet(200);
new Streets('Alante', 1994).calcAvgStreet(200);
new Streets('Alante', 1994).sizeClass(100);
*/
